export default {
  ...
  profile: {
    ...
    toast: {
      ...
      pwdCurrentRequired: '現在のパスワードを入力してください',
      pwdOk: 'パスワードを更新しました',
      ...
      bindLocked: 'このアカウントは解除できません',
      bindUnavailable: 'この連携方式は利用できません',
      unbindOk: '連携を解除しました',
      unbindFail: '連携の解除に失敗しました',
    },
  },
  ...
  auth: {
    ...
    forgot: {
      eyebrow: 'パスワード再設定',
      title: 'パスワードをお忘れですか',
      subtitle: '登録済みのメールアドレスを入力してください。認証コードをお送りします。',
      disabledTitle: 'パスワード再設定は無効です',
      disabledBody: 'このサーバーではパスワード再設定が無効になっています。管理者にお問い合わせください。',
      emailRequired: 'メールアドレスを入力してください',
      sendCode: '認証コードを送信',
      sending: '送信中…',
      sendSuccess: '認証コードを送信しました。受信箱をご確認ください。',
      sendFailed: '認証コードの送信に失敗しました',
      cooldown: '{n} 秒後に再送可能',
      remember: 'パスワードを思い出した？',
    },
    reset: {
      eyebrow: 'パスワード再設定',
      title: '新しいパスワードを設定',
      subtitle: 'メールに届いた認証コードを入力し、新しいパスワードを設定してください。',
      codeHint: '認証コードは数分で失効します。期限切れの場合は再取得してください。',
      submit: 'パスワードを更新',
      submitting: '更新中…',
      success: 'パスワードを再設定しました',
      failed: 'パスワードの再設定に失敗しました',
      resend: '認証コードが届かない？',
      vEmailRequired: 'メールアドレスを入力してください',
      vCodeRequired: '認証コードを入力してください',
    },
  },
