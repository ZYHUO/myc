export default {
  ...
  keys: {
    ...
    fields: {
      ...
      quota: '用量配额（USD）',
      zeroUnlimited: '0 = 不限',
      resetQuota: '重置已用配额（当前 ${used}）',
      rateLimits: '限速配额（USD）',
      rate5h: '5 小时',
      rate1d: '24 小时',
      rate7d: '7 天',
      resetRateUsage: '重置限速窗口计数',
      ipWhitelist: 'IP 白名单',
      ipBlacklist: 'IP 黑名单',
  ...
  auth: {
    ...
    forgot: {
      eyebrow: '密码找回',
      title: '忘记密码',
      subtitle: '输入注册邮箱，我们会发送一封验证码邮件帮你重置密码。',
      disabledTitle: '密码找回已关闭',
      disabledBody: '本服务暂未开启密码找回，请联系管理员。',
      emailRequired: '请输入邮箱',
      sendCode: '发送验证码',
      sending: '发送中…',
      sendSuccess: '验证码已发送，请查收邮箱。',
    ...
    reset: {
      eyebrow: '重置密码',
      title: '设置新密码',
      subtitle: '输入邮箱中的验证码并设置新密码。',
      codeHint: '验证码会在几分钟后过期，过期请重新获取。',
      submit: '重置密码',
      submitting: '重置中…',
      success: '密码已重置',
      failed: '重置密码失败',
