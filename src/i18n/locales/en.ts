export default {
  ...
  keys: {
    ...
    fields: {
      ...
      expiresHint: 'Leave empty to never expire',
      quota: 'Usage quota (USD)',
      zeroUnlimited: '0 = unlimited',
      resetQuota: 'Reset used quota (currently ${used})',
      rateLimits: 'Rate limits (USD)',
      rate5h: 'Last 5h',
      rate1d: 'Last 24h',
      rate7d: 'Last 7d',
      resetRateUsage: 'Reset the rate-limit counters',
      ipWhitelist: 'IP allow-list',
      ipBlacklist: 'IP block-list',
      ipPlaceholder: 'One IP per line\n10.0.0.1\n192.168.1.0/24',
    },
    connect: {
      title: 'Use this key',
      baseUrl: 'Base URL',
      baseUrlHint: 'Point your SDK or HTTP client at this URL. Same base for OpenAI and Anthropic compatible calls.',
      apiKey: 'API key',
      useIt: 'Quick start',
  ...
  profile: {
    ...
    toast: {
      ...
      pwdCurrentRequired: 'Enter your current password',
      ...
      bindLocked: 'This account cannot be unlinked',
      bindUnavailable: 'This provider is not available for linking',
      unbindOk: 'Account unlinked',
      unbindFail: 'Failed to unlink account',
    },
  },
  ...
  auth: {
    ...
    forgot: {
      ...
      disabledTitle: 'Password reset is disabled',
      disabledBody: 'This server has disabled password recovery. Please contact your administrator.',
    ...
    reset: {
      ...
      codeHint: 'The code expires after a few minutes — request a new one if it stops working.',
      submit: 'Reset password',
      submitting: 'Resetting…',
      success: 'Password reset successful',
      failed: 'Failed to reset password',
      resend: 'Need a new code?',
      vEmailRequired: 'Email is required',
