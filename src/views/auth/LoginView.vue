    ...
    <main class="flex flex-1 items-center justify-center px-6">
      <div class="w-full max-w-[420px]">
        ...
        <form class="mt-8 space-y-5" @submit.prevent="handleSubmit">
          <div>
            <label for="login-username" class="text-[11px] uppercase tracking-[0.18em] text-muted-fg font-medium mb-1.5 block">
              Username
            </label>
            <UiInput
              id="login-username"
        ...
        <p v-if="isMockMode()" class="mt-6 text-xs text-muted-fg leading-relaxed">
          ...
          Any non-empty username and password are accepted. Set
